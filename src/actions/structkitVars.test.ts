import { createStructKitVarsAction } from './structkitVars';
...
describe('structkit:vars', () => {
  const action = createStructKitVarsAction();
  ...
  it('should have the correct id', () => {
    expect(action.id).toBe('structkit:vars');
  });
  ...
  it('should have vars output schema', () => {
