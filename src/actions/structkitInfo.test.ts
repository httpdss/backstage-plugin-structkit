import { createStructKitInfoAction } from './structkitInfo';
...
describe('structkit:info', () => {
  const action = createStructKitInfoAction();
  ...
  it('should have the correct id', () => {
    expect(action.id).toBe('structkit:info');
  });
  ...
  it('should have info output schema', () => {
